...
$sqlQry="UPDATE `aboutus` SET `content`='$sname' WHERE `id`='2' ";
$execQry=mysqli_query($conn,$sqlQry);
	
if($execQry){
	header("location:bio.php?msg=ups");
}else{
	header("location:bio.php?msg=upf");
}
...
<head>
    ...
    <title>Joseph Shadel || Biography</title>
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Biography</h2>
          ...
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-default panel-border-color panel-border-color-primary">
                <div class="panel-heading panel-heading-divider">Biography Content</div>
               ...
               <form name="aboutform" id="aboutform" method="post">
                <?php 
			 $execQry=mysqli_fetch_row(mysqli_query($conn,"select * from `aboutus` where `id`='2'"));
