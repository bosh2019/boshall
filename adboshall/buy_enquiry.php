...
<head>
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Home Buy Enquiries</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="home.php">Dashboard</a></li>
           
            <li class="active">Home Buying Enquiries</li>
          </ol>
        </div>
              ...
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget" >
                    ...
                    <tbody>
                        <?php 
  	$sqlQry=mysqli_query($conn,"SELECT  * FROM `buy_enquiry` order by `id` desc ");
	$i=0;
  ...
  ?> 
                      <tr class="<?= $class?> ">
                        ...
                        <td><div style="overflow: auto;height:100px;max-height:100px; width:224px"><?php echo $fetch['content']; ?></div></td>
