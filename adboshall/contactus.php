...
<head>
    ...
    <title>Joseph Shadel || Contact-us Queries</title>
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Contact-us Queries</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="home.php">Dashboard</a></li>
           
            <li class="active">Contact-us Queries</li>
          </ol>
        </div>
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Queries
                  <div class="tools"><a href="contactlist.php"><span class="icon mdi mdi-download"></span></a></div>
                </div>
