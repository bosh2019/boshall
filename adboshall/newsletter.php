...
<head>
    ...
    <title>Joseph Shadel || Newsletter Subscriber</title>
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Newsletter Subscriber</h2>
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Subscribers
                  <div class="tools"><a href="newsletterlist.php"><span class="icon mdi mdi-download"></span></a></div>
                </div>
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    <tbody>
                        <?php 
  	$sqlQry=mysqli_query($conn,"select * from `subscribe`  order by `id` ASC ");
	$i=0;
