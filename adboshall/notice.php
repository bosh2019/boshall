...
$delQry=mysqli_query($conn,"update `notices` set  `visible`= '1'");
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Notifications</h2>
            ...
            <div class="col-sm-12">
              <div class="panel panel-default panel-table">
                <div class="panel-heading">Notifications
                  <div class="tools"><a href="notifications.php"><span class="icon mdi mdi-download"></span></a></div>
                </div>
