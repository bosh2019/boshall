...
header("Content-type: application/octet-stream");  
    header("Content-Disposition: attachment; filename=Property_type_Report.xls");  
                      ...
                      <tr>
                        ...
                        <th>Name</th>
                         <th>Slug</th>
									...
									<tbody>
									 <?php 
  	$sqlQry=mysqli_query($conn,"select * from `propertytype` where `status`='1'  order by `id` ASC ");
	$i=0;
