...
*/  
          ...
          -->      </div>
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    <thead>
                      <tr>
                        ...
                        <th align="center">Details</th>
                         <th align="center">View Images</th>
                        <th>Delete</th>
                       <!-- <th>Edit</th>-->
                        <th>Status</th>
                      </tr>
                    ...
                    <tbody>
                        <?php 
  	$sqlQry=mysqli_query($conn,"select * from `mlspindata_master`  order by `id` asc limit 0,100 ");
	$i=0;
  ...
  ?> 
                      <tr class="<?= $class?> ">
                        ...
                        <td><?php echo $fetch['PropertyType']?></td>
                         <td class="center"><a href="viewproperty.php?id=<?php echo base64_encode($fetch['id'])?>">  <button = class="btn btn-rounded btn-space btn-primary"><i class="icon icon-left mdi mdi-eye"> View</i></button> </a></td>
                          <td class="center"><a href="addimages.php?id=<?php echo base64_encode($fetch['id'])?>">  <button = class="btn btn-rounded btn-space btn-warning"><i class="icon icon-left mdi mdi-image"> View</i></button> </a></td>
	...
	<!--<td class="center" ><a href="addproperty.php?eid=<?php echo base64_encode($fetch['id']) ?>"><img src="<?php echo $baseurl;?>/images/pen.png" style="width:20px; height:20px">	</a></td>-->
		<td class="center" >
       <div class="be-checkbox be-checkbox-color inline"> <input class='uniform ap' type="checkbox" id="check<?php echo $fetch['id']  ?>" value="<?php echo $fetch['status']  ?>" onClick="updateStatus('<?php echo $fetch['id'];  ?>','mlspindata_master',77)" <?php if($fetch['status']==1){echo 'checked';} ?>>
