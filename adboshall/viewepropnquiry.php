...
<head>
    ...
    <title>Joseph Shadel || Property Queries</title>
  ...
  <body>
    <div class="be-wrapper">
      ...
      <div class="be-content">
        <div class="page-head">
          <h2 class="page-head-title">Property Query - '<?php echo getpropertynamefromid($conn,$pid)?>'</h2>
          <ol class="breadcrumb page-head-nav">
            <li><a href="home.php">Dashboard</a></li>
            <li><a href="propertyquery.php">Property Query</a></li>
              ...
              <div class="panel panel-default panel-table">
                ...
                <div class="panel-body">
                  <table id="table1" class="table table-striped table-hover table-fw-widget">
                    ...
                    <tbody>
                        <?php 
  	$sqlQry=mysqli_query($conn,"select * from `proenq` where `propid`='$pid' order by `id` desc ");
	$i=0;
  ...
  ?> 
                      ...
                      <td><?php echo $fetch['propname']?></td>
                        <td><?php echo $fetch['propemail']?></td>
                        <td><?php echo $fetch['propphone']?></td>
                        <td><?php echo $fetch['propmsg']?></td>
