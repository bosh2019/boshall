...
function initCitybook() {
 ...
 initAutocomplete();
    ...
    sbp.on("click", function () {
        $(this).closest(".list-carousel").find('.city-carousel').slick('slickPrev');
    });
    sbn.on("click", function () {
        $(this).closest(".list-carousel").find('.city-carousel').slick('slickNext');
    });
...
$(".ldpGrayDayOptionContainer").click(function(){
  $(".ldpGrayDayOptionContainer").removeClass("selected-item");
